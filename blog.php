...
<!-- Mirrored from kamleshyadav.com/html/portfolio/color_version/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2020 08:44:35 GMT -->
<head>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="preloader">
			<div class="status" ><img src="assets/images/loader.gif" id="preloader_image" alt="loader">
			</div>
		</div>
							...
							<div class="blog_wrapper">
								<div class="blog_data">
									<div class="blog_thumb">
										<img src="assets/images/port_singleblog01.jpg" alt="blog-image" class="img-fluid">
									</div>
									<div class="blog_content">
										<div class="blog_postinfo pb-3">
											<ul>
												<li><a href="javascript:;"> <i class="fas fa-calendar-alt"></i> january 21st, 2019</a></li>
												<li><a href="javascript:;"> <i class="fas fa-comments"></i> 1 Comment</a></li>
												<li><a href="javascript:;"> <i class="fas fa-user-edit"></i> by admin</a></li>
											</ul>
										</div>
										<h4 class="blog_heading">We are provide unique ideas we help clients.</h4>
										<p class="pt-3 pb-3">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Syd College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsa passage, and going through the cites of the word in the undoubtable source.</p>
										
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
										<blockquote>
											<i class="fas fa-quote-left blockquote_icon"></i>There are many variations of passages of Lorem Ipsum available, but an majority have suffered alteration in some form, by injected humour, they randomised words which don't look even slightly believable.</blockquote>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
										<div class="blog_shareinfo">
											<div class="blog_tag">
												<a href="javascript:;"> <i class="fas fa-tags"></i> education, Software, portfolio</a>
											</div>
								...
								<div class="widget blog_comment">
									<div class="singlepost_title">
										<h4 class="widget_title">Comments (3)</h4>
									</div>
									<ul>
										<li class="latest_comment">
											<div class="comment_thumb">
												<img src="assets/images/singleblog_user01.png" alt="image" class="img-fluid"/>
											</div>
											<div class="comment_data">
												...
												<a href="javascript:;" class="comment_reply"><i class="fas fa-reply"></i> reply</a>
											</div>
										</li>
										<li class="latest_comment sub_replay">
											<div class="comment_thumb">
												<img src="assets/images/singleblog_user02.png" alt="image" class="img-fluid"/>
											</div>
											<div class="comment_data">
												<div class="client_name">
													<h5>Taylor Johns</h5>
										...
										<li class="latest_comment">
											<div class="comment_thumb">
												<img src="assets/images/singleblog_user03.png" alt="image" class="img-fluid"/>
											</div>
											<div class="comment_data">
												<div class="client_name">
													<h5>Walter Mark</h5>
								...
								<div class="widget blog_reply">
									<div class="singlepost_title">
										<h4 class="widget_title">post a comment</h4>
									</div>
									<div class="row">
										<div class="col-12">
											<div class="port_contact_form">
												<form>
													<div class="row">
														<div class="col-sm-6">
															  <div class="form-group">
																<input type="text" name="first_name" class="form-control require" id="name" placeholder="First name">
															  </div>
														</div>
														<div class="col-sm-6">
															  <div class="form-group">
																<input type="text" name="last_name" class="form-control require" id="last-name" placeholder="Last name" >
															  </div>
														</div>
														<div class="col-sm-6">
															  <div class="form-group">
																<input type="email" name="email" class="form-control require" id="email" placeholder="Email Address" data-valid="email" data-error="Email should be valid.">
															  </div>
														</div>
														<div class="col-sm-6">
															  <div class="form-group">
																<input type="text" name="subject" class="form-control require" id="subject" placeholder="Subject">
															  </div>
														</div>
														<div class="col-12">
															  <div class="form-group">
																<textarea  name="message" class="form-control require" rows="3" id="comment" placeholder="Message"></textarea>
															  </div>
														</div>
														<div class="col-12">
															<div class="banner_btn">
																<button type="button" class="portfolio_btn btn_red">
							...
							<div class="blogsidebar_wrapper">
								...
								<div class="widget repost_widget">
									...
									<div class="widget_rp">
										<ul>
											<li>
												<div class="rp_thumb"><a href="javascript:;"><img src="assets/images/blog_insta01.jpg" alt="image" class="img-fluid"/></a></div>
												<div class="rp_data">
												<a href="javascript:;" class="rp_heading">Unique ideas products are complited project.</a>
												<div><a href="javascript:;" class="rp_date">january 21st, 2019</a></div>
												</div>
											</li>
											<li>
												<div class="rp_thumb"><a href="javascript:;"><img src="assets/images/blog_insta02.jpg" alt="image" class="img-fluid"/></a></div>
												<div class="rp_data">
												<a href="javascript:;" class="rp_heading">Contrary to is not simply random text.</a>
												<div><a href="javascript:;" class="rp_date">January 21st, 2019</a></div>
												</div>
											</li>
											<li>
												<div class="rp_thumb"><a href="javascript:;"><img src="assets/images/blog_insta03.jpg" alt="image" class="img-fluid"/></a></div>
												<div class="rp_data">
												<a href="javascript:;" class="rp_heading">it has a more-or-less normal of letters.</a>
												<div><a href="javascript:;" class="rp_date">January 21st, 2019</a></div>
												</div>
											</li>
											<li>
												<div class="rp_thumb"><a href="javascript:;"><img src="assets/images/blog_insta04.jpg" alt="image" class="img-fluid"/></a></div>
												<div class="rp_data">
												<a href="javascript:;" class="rp_heading">Unique ideas products are complited project.</a>
												<div><a href="javascript:;" class="rp_date">January 21st, 2019</a></div>
												</div>
											...
											<li>
												<div class="rp_thumb"><a href="javascript:;"><img src="assets/images/blog_insta05.jpg" alt="image" class="img-fluid"/></a></div>
												<div class="rp_data">
												<a href="javascript:;" class="rp_heading">The standard chunk of used since the 1500s.</a>
												<div><a href="javascript:;" class="rp_date">January 21st, 2019</a></div>
												</div>
											</li>
										</ul>
								...
								<div class="widget categroies_widget">
									...
									<ul>
										<li><a href="javascript:;">Education <span class="category_num">(20)</span></a></li>
										<li><a href="javascript:;">Designer <span class="category_num">(50)</span></a></li>
										<li><a href="javascript:;">Projects <span class="category_num">(20)</span></a></li>
										<li><a href="javascript:;">Developer <span class="category_num">(70)</span></a></li>
										<li><a href="javascript:;">Clients <span class="category_num">(90)</span></a></li>
										<li><a href="javascript:;">Creativity <span class="category_num">(100)</span></a></li>
										<li><a href="javascript:;">Education <span class="category_num">(200)</span></a></li>
										<li><a href="javascript:;"> Angular <span class="category_num">(80)</span></a></li>
									</ul>
								</div>
								<div class="widget tag_widget">
									<h4 class="widget_title">Tag</h4>
									<ul>
										<li><a href="javascript:;" class="comment_reply">Education</a></li>
										<li><a href="javascript:;" class="comment_reply">Experience</a></li>
										<li><a href="javascript:;" class="comment_reply">Years </a></li>
										<li><a href="javascript:;" class="comment_reply">Angular</a></li>
										<li><a href="javascript:;" class="comment_reply">Creativity</a></li>
										<li><a href="javascript:;" class="comment_reply">Developer</a></li>
										<li><a href="javascript:;" class="comment_reply">Industry</a></li>
										<li><a href="javascript:;" class="comment_reply">Education</a></li>
										<li><a href="javascript:;" class="comment_reply">Freelance  </a></li>
									</ul>									
								</div>
								<div class="widget insta_widget">
									<h4 class="widget_title">instagram</h4>
									<ul>
										<li><a href="javascript:;"><img src="assets/images/blog_insta01.jpg" alt="image" class="img-fluid"/></a></li>
										<li><a href="javascript:;"><img src="assets/images/blog_insta02.jpg" alt="image" class="img-fluid"/></a></li>
										<li><a href="javascript:;"><img src="assets/images/blog_insta03.jpg" alt="image" class="img-fluid"/></a></li>
										<li><a href="javascript:;"><img src="assets/images/blog_insta04.jpg" alt="image" class="img-fluid"/></a></li>
										<li><a href="javascript:;"><img src="assets/images/blog_insta05.jpg" alt="image" class="img-fluid"/></a></li>
										<li><a href="javascript:;"><img src="assets/images/blog_insta06.jpg" alt="image" class="img-fluid"/></a></li>
									</ul>									
								</div>
							</div>
						</div>	
					...
					<div class="footer_section">
								...
								<div class="row">
									...
									<div class="col-sm-4 text-center">
										<div class="contact_info">
											...
											<p><a href="javascript:;">+(81)52 13698-5745</a></p>
											<p><a href="javascript:;">+(74)12 13698-7412</a></p>
										</div>
									</div>
									<div class="col-sm-4 text-center">
										<div class="contact_info">
											...
											<p><a href="javascript:;">yourname@gmail.com</a></p>
											<p><a href="javascript:;">companyname@gmail.com</a></p>
										</div>
									</div>
						...
						<div class="copy_right_wrapper ">
							<div class="col-12 text-center">
								<p class="copy_right">Copyright &copy; 2019 <a href="javascript:;">Portfolio.</a> All Rights Reserved</p>
							</div>
						</div>
					</div>
...
<!-- Mirrored from kamleshyadav.com/html/portfolio/color_version/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2020 08:44:47 GMT -->
</html>