...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Abhijitsinh">
        <meta name="MobileOptimized" content="320">
        <!-- Primary Meta Tags -->
        <meta name="title" content="Hi! I am Abhijitsinh Piludaria">
        <meta name="description" content="Experienced PHP Programmer with a demonstrated history of working in the information technology and services industry. Skilled in PHP, CodeIgniter, AWS Elastic Beanstalk, Amazon Web Services (AWS), and AJAX. Strong engineering professional with an M.Sc.(I.T.) focused on MSC(it) from UKA TARSADIA UNIVERSITY. ">
        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="https://abhijitpiludaria.com/">
        <meta property="fb:page_id" content="2809040922554886">
        <meta property="og:title" content="Hi! I am Abhijitsinh Piludaria">
        <meta property="og:description" content="Experienced PHP Programmer with a demonstrated history of working in the information technology and services industry. Skilled in PHP, CodeIgniter, AWS Elastic Beanstalk, Amazon Web Services (AWS), and AJAX. Strong engineering professional with an M.Sc.(I.T.) focused on MSC(it) from UKA TARSADIA UNIVERSITY. ">
        <meta property="og:image" content="https://abhijitpiludaria.com/assets/images/alogo1.png">
        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="https://abhijitpiludaria.com/">
        <meta property="twitter:title" content="Hi! I am Abhijitsinh Piludaria">
        <meta property="twitter:description" content="Experienced PHP Programmer with a demonstrated history of working in the information technology and services industry. Skilled in PHP, CodeIgniter, AWS Elastic Beanstalk, Amazon Web Services (AWS), and AJAX. Strong engineering professional with an M.Sc.(I.T.) focused on MSC(it) from UKA TARSADIA UNIVERSITY. ">
        <meta property="twitter:image" content="https://abhijitpiludaria.com/assets/images/alogo1.png">
        <!--Start Style -->
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/all.min.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/font.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/animate.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/magnific-popup.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/swiper.min.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/jquery-jvectormap-2.0.3.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/style.css">
        <link rel="stylesheet" href="<?php echo constant('base_url'); ?>assets/css/scrollbar.css">
        <!-- Favicon Link -->
        <link rel="shortcut icon" type="image/png" href="<?php echo constant('base_url'); ?>assets/images/alogo1.png">
        <title>Home</title>
    </head>
    <body>
        ...
        <div class="preloader">
            <div class="status" >
                <img src="<?php echo constant('base_url'); ?>assets/images/loader.gif" id="preloader_image" alt="loader">
            </div>
        </div>
            ...
            <div class="port_sidebar_profile">
                <a href="javascript:;" class="port_sidebar_position active">
                    <div class="profile_circle">
                        <img src="<?php echo constant('base_url'); ?>assets/images/alogo.png" alt="profile-image" class="img-fluid"/>
                    </div>
                </a>
            </div>
            ...
            <div class="port_sidebar_social">
                <div class="port__social_box">
                    ...
                    <ul class="social_list">
                        <li>
                            <a href="<?php echo constant('facebook'); ?>" target="_blank" class="siderbar_icon">
                        ...
                        <li>
                            <a href="<?php echo constant('linkedin'); ?>" target="_blank" class="siderbar_icon">
                        ...
                        <li>
                            <a href="<?php echo constant('twitter'); ?>" target="_blank" class="siderbar_icon">
                        ...
                        <li>
                            <a href="<?php echo constant('instagram'); ?>" target="_blank" class="siderbar_icon">
